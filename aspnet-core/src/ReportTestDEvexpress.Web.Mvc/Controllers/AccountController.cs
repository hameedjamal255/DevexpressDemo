...
using ReportTestDEvexpress.Web.Models.Account;
using ReportTestDEvexpress.Web.Views.Shared.Components.TenantChange;

namespace ReportTestDEvexpress.Web.Controllers
{
    public class AccountController : ReportTestDEvexpressControllerBase
    {
