...
{
    public abstract class ReportTestDEvexpressWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ReportTestDEvexpressWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ReportTestDEvexpressWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ReportTestDEvexpressDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ReportTestDEvexpressDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ReportTestDEvexpressDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ReportTestDEvexpressDbContext, Task<T>> func)
        {
            T result;
